...
import F8Header             from '../../components/common/Header';
...
class RelayLoading extends Component {
  ...
  renderChild(child, props) {
    ...
    return cloneElement(child, {...this.props, ...props});
  }
}
...
class ListContainer extends Component {
  ...
  render() {
    ...
    const segments = [];
    const content = Children.map(this.props.children, (child, idx) => {
      segments.push(child.props.title);
      return <RelayLoading>{cloneElement(child, {
